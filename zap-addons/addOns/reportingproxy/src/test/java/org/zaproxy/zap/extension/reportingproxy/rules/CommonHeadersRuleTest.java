...
class CommonHeadersRuleTest {
    ...
    private HttpMessage httpRespMsg1_1;
    private HttpMessage httpRespMsg1_2;
    private HttpMessage httpRespMsg1_3;
    private HttpMessage httpRespMsg1_4;
    private HttpMessage httpRespMsg1_5;
    ...
    void setup() {
        ...
        httpRespMsg1_1 = createHttpRespMsg(listForMsg1);
        httpRespMsg1_2 = createHttpRespMsg(listForMsg1);
        httpRespMsg1_3 = createHttpRespMsg(listForMsg1);
        httpRespMsg1_4 = createHttpRespMsg(listForMsg1);
        httpRespMsg1_5 = createHttpRespMsg(listForMsg1);
        // For creating of (first-concluded) second HttpMessage
        httpRespMsg2 = createHttpRespMsg(listForMsg2);
        // For creating of (first-different) third HttpMessage
    ...
    void updateBufferWith() {
        ...
        assertNull(commonHeadersRule.checkViolation(httpRespMsg1_1));
    ...
    void isViolatedTrue() {
        ...
        assertNull(commonHeadersRule.checkViolation(httpRespMsg1_3));
        assertNull(commonHeadersRule.checkViolation(httpRespMsg1_4));
        assertNull(commonHeadersRule.checkViolation(httpRespMsg1_5));
