...
class HiddenFieldRuleTest {
    ...
    //    }
    //
    //    private HttpMessage createHttpMsg(String url) throws URIException,
    ...
    //    void getDescription() {
    //        HiddenFieldRule hiddenFieldRule = new HiddenFieldRule();
    //        assertEquals("Check if Hidden Field ever sent to different
    // domain",hiddenFieldRule.getDescription());
    //    }
    //
    //    @Test
    ...
    //
    //            // serial assertion
    //            assertFalse(hiddenFieldRule.isViolated(httpMessageCorrect));
    //            assertFalse(hiddenFieldRule.isViolated(httpMessageCorrect2));
    //            assertTrue(hiddenFieldRule.isViolated(httpMessageWrong));
    //        }
    //    }
}
