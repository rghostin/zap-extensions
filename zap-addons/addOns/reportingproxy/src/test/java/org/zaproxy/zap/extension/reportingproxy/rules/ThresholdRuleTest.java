...
class ThresholdRuleTest {
    ...
    // checks for the case in which the flagged domain is detected it exceeds request threshold
    @Test
    ...
    // checks for the case in which the flagged domain is detected it does not request threshold
    @Test
